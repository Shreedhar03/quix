...
const Question = () => {
    ...
    return (
        <>
            <div className='bg-cyan p-3 rounded-lg z-40'>
                <input type="text"
                    autoFocus
                    placeholder='Add a question'
                    className='focus:outline-none bg-inherit font-semibold border-b-2 focus:border-b-blue border-b-blue/50 text-xl p-2 placeholder:text-blue/70 w-10/12' />
                <div className='my-4'>
